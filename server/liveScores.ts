 ...
 */
function cfbNameKey(s: string): string {
  const base = String(s || "")
    .normalize("NFD")
...
const KALSHI_TEAM_ALIASES: Record<string, string> = {
...
const pairKeyOf = (a: string, b: string) => [cfbNameKey(a), cfbNameKey(b)].sort().join("__");
